...
------------------
   ...
   Our products are distributed as Windows Installer files which install the
   product when run.
...
--------------
   ...
   The following files are included with Take Command 18.0:

     TCMD.EXE            Take Command program file
     TCC.EXE             Take Command Console program file (formerly 4NT.EXE)
     ...
     EVERYTHING32.DLL    Everything Search support dll
     ...
     IPWORKSSSH9.DLL     Internet SSH functions support DLL
     ...
     LUA52.DLL           Lua support DLL for TCC
     ONIG.DLL            Regular expression support DLL
     README.TXT          This file
     regid.2002-09.com.jpsoft_Take Command 18.0.swidtag  
     ...
     TCMDBATCH.BTM       Batch file to make TCMD the default handler for
                           .BAT, .BTM, and/or .CMD batch files       
...
-------------------------------
   ...
   versions, visit our web or ftp sites at:
