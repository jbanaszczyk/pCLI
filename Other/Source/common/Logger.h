...
namespace logger {
	...
	inline bool isTrace() {
		return loggerSeverityLevel::trace >= internal::currentSeverityLevel;
	}

	inline bool isDebug() {
		return loggerSeverityLevel::debug >= internal::currentSeverityLevel;
	}

	inline bool isInfo() {
		return loggerSeverityLevel::info >= internal::currentSeverityLevel;
	}

	inline bool isWarning() {
		return loggerSeverityLevel::warning >= internal::currentSeverityLevel;
	}

	inline bool isError() {
		return loggerSeverityLevel::error >= internal::currentSeverityLevel;
	}

	inline bool isFatal() {
		return loggerSeverityLevel::fatal >= internal::currentSeverityLevel;
	}
